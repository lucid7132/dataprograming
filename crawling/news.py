...
argparser.add_argument("--start-date", type=str, default="2025.10.01")  # 시작 날짜 
argparser.add_argument("--end-date", type=str, default="2025.10.31")    # 끝 날짜 
...
argparser.add_argument("--sleep-time", type=float, default=0.5)    # 요청 대기 시간


argparser.add_argument("--output-path", type=str, default="")      # 저장 시 키워드 파일명으로 지정 가능
